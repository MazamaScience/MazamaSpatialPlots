...
We also introduce a U.S. state Spatial Polygons Data Frame (SPDF) so the monitor 
...
Another method to map monitor loactions is to use the `monitor_map()` function 
