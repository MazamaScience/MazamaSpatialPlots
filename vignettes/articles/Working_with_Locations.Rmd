...
Now, the _ws_monitor_ object, `monitorLatestData` and the monitor-level dataframe, `dailyMax`, can be used to create air quality maps as demonstrated in the following sections.
