...
**MazamaSpatialPlots** package. Additionally, this document will provide examples to show the usage of the `stateMap()` function's additional arguments.
...
### Using package dataframe `example_US_stateObjesity`
...
stateMap(
  ...
  state_SPDF = "USCensusStates_02", # the default value
